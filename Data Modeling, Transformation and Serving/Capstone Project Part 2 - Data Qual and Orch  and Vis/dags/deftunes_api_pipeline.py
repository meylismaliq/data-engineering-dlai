...
# replace `<DATA-LAKE-BUCKET>` with the DataLakeBucket value
DATA_BUCKET_NAME = "de-c4w4a2-909851488623-us-east-1-data-lake"
# replace `<SCRIPTS-BUCKET>` with the ScriptsBucket value
SCRIPTS_BUCKET_NAME = "de-c4w4a2-909851488623-us-east-1-scripts"
# replace `<API-ENDPOINT>` with the APIEndpoint value
API_URL = "ec2-52-204-126-103.compute-1.amazonaws.com"
...
def deftunes_pipeline():
    ...
    api_users_extract_glue_job = GlueJobOperator(
        ...
        iam_role_name="de-c4w4a2-glue-role",
    ...
    json_transform_glue_job = GlueJobOperator(
        ...
        script_args={
            "--catalog_database": "de_c4w4a2_silver_db",
            "--ingest_date": "{{ next_ds }}",
    ...
    dq_check_users_job = GlueDataQualityRuleSetEvaluationRunOperator(
        ...
        role="arn:aws:iam::909851488623:role/de-c4w4a2-glue-role",
        ...
        datasource={
            "GlueTable": {
                "TableName": "users",
                "DatabaseName": "de_c4w4a2_silver_db",
            }
        },
    )
